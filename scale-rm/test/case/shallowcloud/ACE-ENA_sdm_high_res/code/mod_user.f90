...
!! @li      2017-12-24 (S.Shima)       [fix] the module used for TIME_DOATMOS_PHY_RD
!! @li      2017-12-24 (S.Shima)       [add] QTOT is calculated from QTRC_sdm when using SDM
!! @li      2019-07-29 (S.Shima)       [mod] for SCALE_v5.2.6
!!
!<
!-------------------------------------------------------------------------------
module mod_user
